package com.frizzle.compiler.utils;
...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String AROUTER_ANNOTATION_TYPES = "com.frizzle.annotation.ARouter";
    public static final String PARAMETER_ANNOTATION_TYPES = "com.frizzle.annotation.Parameter";
    ...
    // 包名前缀封装
    public static final String BASE_PACKAGE = "com.frizzle.api";
    // 路由组Group加载接口
